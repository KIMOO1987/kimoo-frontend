...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'OKX Signal Bot', icon: (props: { size?: number }) => <img src="/okx.png" alt="OKX Signal Bot" width={props.size || 18} height={props.size || 18} className="object-contain" style={{ filter: 'hue-rotate(90deg)' }} />, path: '/dashboard/okx_bot', minTier: 2 },
