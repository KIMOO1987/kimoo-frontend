      ...
      <div className="relative z-10 w-full max-w-md p-10 md:p-12 border border-white/[0.08] rounded-[2.5rem] bg-gradient-to-br from-white/[0.04] to-white/[0.01] backdrop-blur-2xl shadow-[0_0_80px_rgba(0,0,0,0.6)]">
        <div className="relative z-10">
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl md:text-3xl font-black italic uppercase tracking-tighter flex items-center justify-center gap-2">
              KIMOO<span className="text-blue-400">CONSOLE</span>
            </h1>
          ...
          <form onSubmit={handleAdminLogin} className="space-y-5">
            ...
            />
            {error && (
              <p className="text-red-400 text-[10px] font-black uppercase text-center bg-red-500/10 border border-red-500/20 py-2.5 rounded-xl">
                {error}
              </p>
            )}
            ...
            <button
              ...
              className={`w-full py-4 mt-4 rounded-xl font-black text-[11px] uppercase tracking-[0.2em] transition-all duration-300 active:scale-95 flex items-center justify-center gap-3 ${
                loading
                  ? 'bg-white/[0.05] border border-white/5 text-zinc-500 cursor-not-allowed'
                  : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 border border-blue-500/30 text-white shadow-[0_0_30px_rgba(59,130,246,0.3)]'
              }`}
            >
