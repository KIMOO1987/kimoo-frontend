...
export default function RiskPage() {
  ...
  return (
    <div className="p-4 md:p-8 lg:p-12 max-w-6xl mx-auto space-y-12">
      {/* Header */}
      <header>
        <h1 className="text-3xl md:text-5xl font-black tracking-tighter italic uppercase text-zinc-900 dark:text-white">
          Risk <span className="text-blue-500">Parameters</span>
        </h1>
        <p className="text-zinc-600 dark:text-zinc-500 text-[10px] md:text-xs uppercase tracking-[0.4em] font-bold mt-2">
      ...
      >
        ...
        <motion.div
          ...
          className="group bg-[var(--input-bg)] border border-white/5 p-8 rounded-[2.5rem] hover:border-red-500/20 transition-all duration-500 shadow-2xl shadow-black/50"
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h3 className="font-black uppercase tracking-widest text-[10px] text-zinc-700 dark:text-zinc-400 leading-none">Max Daily Loss</h3>
          ...
          <div className="flex items-baseline gap-3 border-b border-white/5 pb-4 focus-within:border-red-500/30 transition-colors">
            ...
            <input
              ...
              className="bg-transparent text-5xl md:text-6xl font-black text-zinc-900 dark:text-white outline-none w-full tracking-tighter"
              placeholder="0"
            />
          </div>
          <p className="text-[9px] text-zinc-600 dark:text-zinc-500 mt-6 uppercase font-black tracking-[0.2em] opacity-50">
        ...
        <motion.div
          variants={cardVariants}
          className="group bg-[var(--input-bg)] border border-white/5 p-8 rounded-[2.5rem] hover:border-blue-500/20 transition-all duration-500 shadow-2xl shadow-black/50"
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h3 className="font-black uppercase tracking-widest text-[10px] text-zinc-700 dark:text-zinc-400 leading-none">Risk Per Trade</h3>
        ...
        <motion.div
          variants={cardVariants}
          className="group bg-[var(--input-bg)] border border-white/5 p-8 rounded-[2.5rem] hover:border-green-500/20 transition-all duration-500 shadow-2xl shadow-black/50"
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h3 className="font-black uppercase tracking-widest text-[10px] text-zinc-700 dark:text-zinc-400 leading-none">Standard R:R Ratio</h3>
        ...
        <motion.div
          variants={cardVariants}
          className="group bg-[var(--input-bg)] border border-white/5 p-8 rounded-[2.5rem] hover:border-zinc-500/20 transition-all duration-500 shadow-2xl shadow-black/50"
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h3 className="font-black uppercase tracking-widest text-[10px] text-zinc-700 dark:text-zinc-400 leading-none">Daily Profit Goal</h3>
