        ...
        <div className="max-w-[1700px] mx-auto relative z-10 flex flex-col min-h-screen space-y-8">
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-6 mb-6">
            <div>
              ...
              <p className="text-[10px] uppercase tracking-[0.4em] text-zinc-500 font-bold mt-3 leading-none">• CRT PROTOCOL • LIVE INSTITUTIONAL FEED •</p>
            </div>
            ...
            <AnimatePresence mode="popLayout">
              {signals.length > 0 ? signals.map((signal) => (
                ...
                <div className="col-span-full w-full flex flex-col items-center justify-center py-40 border border-dashed border-white/[0.1] rounded-[2.5rem] bg-white/[0.01]">
                  ...
                  <h3 className="text-2xl font-black italic tracking-tighter uppercase text-white mb-2">No Signals Found</h3>
                </div>
              )}
            </AnimatePresence>
          </div>
          ...
          {totalPages > 1 && (
            <div className="mt-8 mb-4 flex justify-center items-center gap-4">
              ...
              <button onClick={() => setCurrentPage(prev => Math.min(prev + 1, totalPages))} disabled={currentPage === totalPages} className="p-3 rounded-xl bg-white/[0.02] border border-white/[0.05] text-zinc-500"><ChevronRight size={20} /></button>
            </div>
          )}
