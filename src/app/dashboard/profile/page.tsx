...
export default function ProfilePage() {
  ...
  const loadProfileData = useCallback(async (user: any) => {
    ...
    try {
      ...
      if (data) {
        ...
        // Fallback to Auth Metadata if profile row isn't ready yet
        setFormData(prev => ({
          ...prev,
  ...
  useEffect(() => {
    ...
    // Listen for auth state changes to catch session updates
  ...
  const handleUpdateProfile = async () => {
    ...
    // Get session directly to avoid "No user found" errors
    const { data: { session } } = await supabase.auth.getSession();
  ...
  if (loading) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center bg-transparent">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-600">Validating Identity...</p>
      </div>
    );
  }
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative opacity-60">
                  <input className="crt-input w-full pl-10 bg-white/5 cursor-not-allowed" value={formData.email} readOnly />
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="crt-card p-6 border-blue-500/20 bg-blue-500/[0.02]">
            ...
            <p className="text-[11px] leading-relaxed text-zinc-400 font-medium">
              Your identity details are used solely for billing and signal localization. KIMOO <span className="text-white italic">CRT</span> uses AES-256 encryption.
            </p>
          </div>
          ...
          <div className="crt-card p-6 border-white/5 bg-white/[0.01]">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-[9px] font-bold text-zinc-600 uppercase">Node Access</span>
