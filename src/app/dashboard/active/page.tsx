...
export default function ActiveSignalsPage() {
  ...
  // Helper to map DB status to your specific UI labels
  ...
  useEffect(() => {
    const fetchActive = async () => {
      ...
      // NEW LOGIC: Filter signals that are NOT yet completed (SL or TP2)
      const { data, error } = await supabase
        .from('signals')
        .select('*')
        .gt('created_at', timeLimit)
        .not('status', 'in', '("SL","TP2")') // Remove from active if SL or TP2 hit
                ...
                <div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <TradeDataRow 
                      ...
                      valueClass="text-blue-400 animate-pulse"
                    />
