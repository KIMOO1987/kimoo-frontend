      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/5 pb-6 mb-8 gap-4">
        <div>
          <div className="flex items-center gap-3">
            <img src="/ctrader-logo.png" alt="cTrader" className="w-8 h-8 object-contain" />
            <h1 className="text-2xl font-black text-white italic tracking-tighter">
              <span className="text-red-500">c</span>Trader Cloud Bridge
            </h1>
          </div>
          <p className="text-[10px] font-bold text-cyan-600 uppercase tracking-widest mt-2">Status: {status === 'running' ? 'Connected' : 'Disconnected'}</p>
        </div>
